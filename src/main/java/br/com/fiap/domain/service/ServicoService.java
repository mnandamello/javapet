...
public class ServicoService implements Service<Servico, Long>{
    ...
    @Override
    public List<Servico> findAll() {return repo.findAll();}

    @Override
    public Servico findById(Long id) {return repo.findById(id);}

    @Override
    public Servico persiste(Servico servico) {return repo.persiste(servico);}
}